...
TOOL_TO_SERVER: Dict[str, str] = {
    ...
    "nav_set_home": "nav_server",
    "nav_set_company": "nav_server",
    "add_via": "nav_server",
    ...
    "poi_condition": "nav_server",
    "ahead_condition": "nav_server",
    "target_condition": "nav_server",
    "traffic_incidents": "nav_server",
    ...
    "nav_zoom_in_max": "nav_server",
    "nav_zoom_out_min": "nav_server",
    ...
    "collect_current_location": "nav_server",
    # Map Settings
    "ask_where": "nav_server",
...
SERVER_TO_TOOLS: Dict[str, List[str]] = {
    "nav_server": [
        # Navigation
        "go_poi", "open_nav", "close_nav", "go_home", "go_company",
        "nav_set_home", "nav_set_company", "add_via", "delete_via",
        ...
        # Traffic Info
        "home_condition", "company_condition", "poi_condition", "ahead_condition",
        "target_condition", "traffic_incidents", "open_electronic_eye", "close_electronic_eye",
        "open_cruise_information", "close_cruise_information",
        # Map
        "nav_zoom_in", "nav_zoom_out", "nav_zoom_in_max", "nav_zoom_out_min",
        ...
        "collect_target_location", "collect_current_location",
        # Settings
